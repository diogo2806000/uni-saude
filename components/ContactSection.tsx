            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
              <div className="flex items-center gap-4 text-brand-600">
                ...
                <div>
                  ...
                  <a href="https://wa.me/5532999513176" className="text-base text-slate-600 hover:text-brand-600" aria-label="Ligar para WhatsApp">
                    (32) 99951-3176
                  </a>
                </div>
              </div>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
              <div className="flex items-center gap-4 text-brand-600">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-600">Av. Barão do Rio Branco, 2500 - Centro, Juiz de Fora - MG</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft">
              <div className="flex items-center gap-4 text-brand-600">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-600">Seg a Sex: 08:00 às 18:00 | Sáb: 08:00 às 12:00</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-3xl border border-slate-200 bg-slate-50 px-5 py-4 text-sm text-slate-900 outline-none focus:border-brand-300 focus:ring-2 focus:ring-brand-100"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center rounded-3xl bg-brand-600 px-6 py-4 text-sm font-semibold text-white shadow-lg shadow-brand-500/20 transition hover:bg-brand-700"
            >
              Solicitar Contato
            </button>
          </div>
